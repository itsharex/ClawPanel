...
[![Lite](https://img.shields.io/badge/Lite-0.1.6-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.8` 补强 macOS OpenClaw 探测、受管工作区兼容与 MiniMax 默认配置；`ClawPanel Lite v0.1.6` 修复 Windows / macOS Lite 误探测本机外部 `openclaw` 的问题，并新增“只卸载本机外部 OpenClaw、不影响 Lite 内嵌运行时”的说明。详见 [changelogs/v5.2.8.md](changelogs/v5.2.8.md) 和 [changelogs/lite-v0.1.6.md](changelogs/lite-v0.1.6.md)
