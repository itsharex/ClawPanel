...
[![Lite](https://img.shields.io/badge/Lite-0.1.8-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.8` 补强 macOS OpenClaw 探测、受管工作区兼容与 MiniMax 默认配置；`ClawPanel Lite v0.1.8` 修复 Lite 包漏打 OpenClaw 运行时依赖导致 `entry.js` 无法导入的问题，并补上打包时的 runtime smoke test。详见 [changelogs/v5.2.8.md](changelogs/v5.2.8.md) 和 [changelogs/lite-v0.1.8.md](changelogs/lite-v0.1.8.md)
